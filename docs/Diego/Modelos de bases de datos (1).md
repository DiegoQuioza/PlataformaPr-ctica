...
```mermaid
    flowchart TB
    PLATFORM[("PLATFORM DATABASE<br/><br/>IAM / Organizations / Plugins / Automations / Billing")]

    subgraph DATABASES["Bases de Datos de la Plataforma"]
        PLUGIN[("PLUGIN DATABASE<br/><br/>Registry<br/>Versions<br/>Dependencies")]
        EXECUTION[("EXECUTION DATABASE<br/><br/>Executions<br/>Jobs<br/>Logs")]
        STORAGE[("STORAGE DATABASE<br/><br/>Files<br/>Quotas<br/>Usage")]
        MARKETPLACE[("MARKETPLACE DATABASE<br/><br/>Listings<br/>Categories<br/>Purchases")]
    end
